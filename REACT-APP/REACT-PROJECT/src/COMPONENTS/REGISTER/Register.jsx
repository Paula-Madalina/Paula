    ...
    <div>
        <div className="background__division">
            ...
            <div className='image__section'>
                ...
                <p className='hero__paragraph'>Start for free and get attractive offers from the community</p>
            </div>
            ...
            <div className="form__section">
               ...
               <div className='form__details'>
                    ...
                    <div className="form__header">
                        ...
                        <p className='form__info'>Welcome back! Please enter your details.</p>
                    </div>
